...
RUNNERS = Registry("runner", parent=MMENGINE_RUNNERS, locations=["mmyolo.engine"])
...
HOOKS = Registry("hook", parent=MMENGINE_HOOKS, locations=["mmyolo.engine.hooks"])

# manage data-related modules
DATASETS = Registry("dataset", parent=MMENGINE_DATASETS, locations=["mmyolo.datasets"])
DATA_SAMPLERS = Registry(
    "data sampler", parent=MMENGINE_DATA_SAMPLERS, locations=["mmyolo.datasets"]
)
TRANSFORMS = Registry(
    "transform", parent=MMENGINE_TRANSFORMS, locations=["mmyolo.datasets.transforms"]
)
...
MODEL_WRAPPERS = Registry(
    "model_wrapper", parent=MMENGINE_MODEL_WRAPPERS, locations=["mmyolo.models"]
)
...
OPTIMIZERS = Registry(
    "optimizer", parent=MMENGINE_OPTIMIZERS, locations=["mmyolo.engine.optimizers"]
)
...
METRICS = Registry("metric", parent=MMENGINE_METRICS, locations=["mmyolo.engine"])
